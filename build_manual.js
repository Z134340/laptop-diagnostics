...
children.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 320 },
  children: [new TextRun({ text: "版本 1.0", size: 20, color: "999999" })] }));
...
children.push(P("MacVitals 是一個幫你的 Mac 做「健康體檢」的小工具。就像人去做健康檢查一樣,它會一次幫你檢查電腦的九個面向,告訴你哪裡正常、哪裡需要注意,並且對常見的小問題提供「一鍵修復」。"));
children.push(P([run("最重要的一點:", { bold: true }), run("整個檢查過程是「唯讀」的——它只是「看」,不會刪除、搬移或改動你的任何檔案。只有在你自己按下修復按鈕、並再次確認之後,它才會動手處理那一項。")]));
children.push(H2("它會檢查哪九個面向?"));
...
children.push(B([run("九個檢查模組一覽:", { bold: true }), run("九張卡片,一眼看完每個面向的結果。點任一張卡片可以跳到該項目看細節。")]));
...
children.push(CAP("報告摘要頁上半部:九個模組一覽 + 整體判讀"));
...
children.push(P("點上方的分頁(M1～M9)即可看該項目的明細。例如「M3 大型檔案」會列出每個大檔,還會用白話告訴你「這是什麼」,方便你判斷能不能刪。"));
